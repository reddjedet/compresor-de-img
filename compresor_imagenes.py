...
def comprimir_imagen(ruta_origen, ruta_destino, calidad=85, tamano=(460, 460)):
    """
...
if __name__ == "__main__":
    ...
    CALIDAD_JPG = 50
    TAMANO_AVATAR = (460, 460)

    print("🚀 Iniciando proceso de compresión de imagen individual...")
    comprimir_imagen(
        RUTA_IMAGEN_ORIGINAL, RUTA_IMAGEN_COMPRIMIDA, CALIDAD_JPG, TAMANO_AVATAR
    )
